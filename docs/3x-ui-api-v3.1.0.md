# 3x-ui Panel API Documentation — v3.1.0

Source: Panel built-in API docs at `/panel/api-docs`

The 3x-ui panel exposes a REST API under `/panel/api/`. Authenticate with the panel session cookie, or with the `Authorization: Bearer <token>` header. Every endpoint returns a uniform `{ success, msg, obj }` envelope unless otherwise noted.

## Table of Contents

- [Authentication](#authentication) (4 endpoints)
- [Inbounds](#inbounds) (13 endpoints)
- [Server](#server) (26 endpoints)
- [Clients](#clients) (20 endpoints)
- [Nodes](#nodes) (9 endpoints)
- [Custom Geo](#custom-geo) (7 endpoints)
- [Backup](#backup) (1 endpoint)
- [Settings](#settings) (6 endpoints)
- [API Tokens](#api-tokens) (4 endpoints)
- [Xray Settings](#xray-settings) (9 endpoints)
- [Subscription Server](#subscription-server) (3 endpoints)
- [WebSocket](#websocket) (5 endpoints)

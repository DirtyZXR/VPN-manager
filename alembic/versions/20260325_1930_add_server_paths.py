...
def upgrade() -> None:
    ...
    op.add_column(
        "servers",
        sa.Column("panel_path", sa.String(length=500), nullable=False, server_default="/"),
    )
    op.add_column(
        "servers",
        sa.Column(
            "subscription_path", sa.String(length=500), nullable=False, server_default="/sub"
        ),
    )
    op.add_column(
        "servers",
